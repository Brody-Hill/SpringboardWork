...
Write a SQL query to produce a list of the names of the facilities that do. */ SELECT Name FROM Facilities WHERE membercost > 0


/* Q2: How many facilities do not charge a fee to members? */ 

SELECT name FROM facilities WHERE member cost = 0 
...
INNER JOIN Facilities AS f
ON b.facid = f.facid
WHERE IF(m.memid > 0, b.slots * f.membercost, b.slots * f.guestcost) > 30 AND starttime BETWEEN '2012-09-14 00:00:00' AND '2012-09-14 99:99:99'
...
ON b.memid = m.memid
WHERE b.starttime BETWEEN '2012-09-14 00:00:00' AND '2012-09-14 99:99:99'
...
SELECT surname, firstname, recommendedby FROM Members ORDER BY surname
...
This shows the usage of each facility my members only, is this what the question was asking? Or is the question asking for each member, what facilities did they use?
